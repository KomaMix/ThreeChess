...
namespace ThreeChess.Migrations
{
    ...
    [Migration("20250624101452_AddOldGamesInfo")]
    partial class AddOldGamesInfo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ThreeChess.Models.OldGameInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("OldGameInfos");
                });

            modelBuilder.Entity("ThreeChess.Models.UserOldGameInfo", b =>
                {
                    b.Property<string>("AppUserId")
                        .HasColumnType("text");

                    b.Property<Guid>("OldGameInfoId")
                        .HasColumnType("uuid");

                    b.HasKey("AppUserId", "OldGameInfoId");

                    b.HasIndex("OldGameInfoId");

                    b.ToTable("UserOldGameInfos");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ThreeChess.Data.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ThreeChess.Models.UserOldGameInfo", b =>
                {
                    ...
                    b.HasOne("ThreeChess.Models.OldGameInfo", "OldGameInfo")
                        .WithMany()
                        .HasForeignKey("OldGameInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AppUser");

                    b.Navigation("OldGameInfo");
                });
